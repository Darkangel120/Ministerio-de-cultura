...
export function AuthProvider({ children }) {
  ...
  const puedeCrearUsuario = usuario && ['admin', 'director_general', 'director_operativo'].includes(usuario.tipo);

  return (
    <AuthContext.Provider value={{ usuario, cultor, cargando, login, registrar, logout, refrescar, esStaff, esAdmin, puedeCrearUsuario }}>
      {children}
