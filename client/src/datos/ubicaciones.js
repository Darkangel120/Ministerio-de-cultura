// División Político-Territorial de Venezuela (INE 2013 / Wikipedia) — 335 municipios.
// Claves = nombres de AREAS_VE. Nombres oficiales de los municipios.
export const MUNICIPIOS_POR_ESTADO = {
  "Distrito Capital": ["Libertador"],
  "Amazonas": ["Alto Orinoco", "Atabapo", "Atures", "Autana", "Manapiare", "Maroa", "Río Negro"],
  "Anzoátegui": ["Anaco", "Aragua", "Bruzual", "Cajigal", "Carvajal", "Diego Bautista Urbaneja", "Freites", "Guanta", "Guanipa", "Independencia", "José Gregorio Monagas", "Libertad", "Miranda", "Peñalver", "Píritu", "San Juan de Capistrano", "Santa Ana", "Simón Bolívar", "Simón Rodríguez", "Sir Arthur McGregor", "Sotillo"],
  ...
  "Bolívar": ["Angostura", "Angostura del Orinoco", "Caroní", "Cedeño", "El Callao", "Gran Sabana", "Padre Pedro Chien", "Piar", "Roscio", "Sifontes", "Sucre"],
  ...
  "Guárico": ["Camaguán", "Chaguaramas", "El Socorro", "Francisco de Miranda", "José Félix Ribas", "José Tadeo Monagas", "Juan Germán Roscio", "Juan José Rondón", "Julián Mellado", "Las Mercedes", "Leonardo Infante", "Ortiz", "San Gerónimo de Guayabal", "San José de Guaribe", "Santa María de Ipire", "Zaraza"],
  ...
  "Trujillo": ["Andrés Bello", "Boconó", "Bolívar", "Candelaria", "Carache", "Carvajal", "Escuque", "José Felipe Márquez Cañizales", "Juan Vicente Campo Elías", "La Ceiba", "Miranda", "Monte Carmelo", "Motatán", "Pampán", "Pampanito", "Rafael Rangel", "Sucre", "Trujillo", "Urdaneta", "Valera"],
  "Vargas": ["Vargas"],
...
export const PARROQUIAS_POR_ESTADO = {
  "Amazonas": {
    "Alto Orinoco": [
